                        ...
                        for (let i = 0; i < parseInt(element.sieges_obtenus); i++) {
                            ...
                            arrayOfSvg.push(
                                <div className="tooltipRectangle col-md-1">
                                    <svg  key={this.props.keyy+index} height="10vh" style={{ marginTop: '1.5vh' }} version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 482.813 482.813" enable-background="new 0 0 482.813 482.813">
